...
from src.ingestion.validation.models import ValidationOutcome, RuleSeverity

RULES_PATH = Path(__file__).resolve().parents[3] / "src" / "reference" / "data_quality_rules.yml"
