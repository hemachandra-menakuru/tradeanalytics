...
# MAGIC %sql
# MAGIC -- Drop reference tables (order doesn't matter — no FK enforcement in Delta)
# MAGIC DROP TABLE IF EXISTS tradeanalytics.reference.instrument;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.reference.instrument_listing;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.reference.universe_membership;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.reference.ticker_feed_config;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.reference.market_calendar;
# MAGIC
# MAGIC -- Drop control tables
# MAGIC DROP TABLE IF EXISTS tradeanalytics.control.ingestion_watermark;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.control.ingestion_batch_config;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.control.ingestion_command;
# MAGIC DROP TABLE IF EXISTS tradeanalytics.control.job_run_log;
# MAGIC
# MAGIC -- Optionally drop the schemas themselves (only if you want a full clean slate)
# MAGIC -- DROP SCHEMA IF EXISTS tradeanalytics.reference;
# MAGIC -- DROP SCHEMA IF EXISTS tradeanalytics.control;
