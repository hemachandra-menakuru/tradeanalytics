...
| 2-Plane Ingestion | Two-plane Bronze pipeline (planner → EC2 agent → raw_to_bronze) | ✅ BUILT & validated end-to-end 2026-07-05 — clean-room SPY 10yr run: 11 INGESTED, 2,639 bars, watermark record_count=2639, 11 job_run_log rows, zero warnings. Full guide: docs/runbooks/ingestion_run_guide.md. Schedules OFF (manual). NEXT: full-universe backfill (7 more instruments) · enable 7pm/8pm crons · PR feature/phase3-silver→main. |
